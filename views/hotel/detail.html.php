        ...
        <div class="col-sm-8 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <hr />
              <span class="float-left btn btn-sm btn-outline-danger disabled"><?= $detail['prix_bien']?></span>
              <span class="float-left btn btn-sm disabled">Ref: <?= $detail['reference_bien']?></span>
              <span class="float-left btn btn-sm disabled">Depuis: <?= $detail['date_creation']?></span>
